...
* The original package name 'com.codingShuttle.ecommerce.order-service' is invalid and this project uses 'com.codingShuttle.ecommerce.order_service' instead.
